...
#define PRINT_HEAD(step) {std::list<PeerlistEntry> bs_head; bool r = plm.get_peerlist_head(bs_head, 100);std::cout << "step " << step << ": " << bs_head.size() << std::endl;}
  ...
  ADD_GRAY_NODE(MAKE_IP(123,43,12,1), 8780, 121241, 34345);
  ADD_GRAY_NODE(MAKE_IP(123,43,12,2), 8780, 121241, 34345);
  ADD_GRAY_NODE(MAKE_IP(123,43,12,3), 8780, 121241, 34345);
  ADD_GRAY_NODE(MAKE_IP(123,43,12,4), 8780, 121241, 34345);
  ADD_GRAY_NODE(MAKE_IP(123,43,12,5), 8780, 121241, 34345);

  ADD_WHITE_NODE(MAKE_IP(123,43,12,1), 8780, 121241, 34345);
  ADD_WHITE_NODE(MAKE_IP(123,43,12,2), 8780, 121241, 34345);
  ADD_WHITE_NODE(MAKE_IP(123,43,12,3), 8780, 121241, 34345);
  ADD_WHITE_NODE(MAKE_IP(123,43,12,4), 8780, 121241, 34345);
