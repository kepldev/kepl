         ...
         Config &config)
{
    ...
    do
    {
        std::cout << InformationMsg("Kepl v"
    ...
    {
        std::cout << WarningMsg("It looks like kepld isn't open!")
                  << std::endl << std::endl
                  << WarningMsg("Ensure kepld is open and has finished "
                                "initializing.")
                  << std::endl
                  << WarningMsg("If it's still not working, try restarting "
                                "kepld. The daemon sometimes gets stuck.")
                  << std::endl
                  << WarningMsg("Alternatively, perhaps kepld can't "
