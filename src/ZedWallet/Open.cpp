...
void viewWalletMsg()
{
    std::cout << InformationMsg("Please remember that when using a view wallet "
              ...
              << std::endl << "This means if you received 100 KEPL and then "
              << "sent 50 KEPL, your balance would appear to still be 100 "
              << "KEPL." << std::endl
...
void connectingMsg()
{
    std::cout << std::endl << "Making initial contact with kepld."
              << std::endl
